 ...
 * Mobile Detect Class
 * 
 * Lightweight detection of mobile devices for Magical Addons
 */
...
/**
 * Simple Mobile Detection for Magical Addons
 */
class Mobile_Detect
{
    /**
    ...
    {
        $this->userAgent = isset($_SERVER['HTTP_USER_AGENT']) ? sanitize_text_field(wp_unslash($_SERVER['HTTP_USER_AGENT'])) : '';
    }
    ...
    {
        return (bool) preg_match('/android|ipad|playbook|silk/i', $this->userAgent) && !$this->isMobile();
    }
}

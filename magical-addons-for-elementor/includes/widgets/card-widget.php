    ...
    function register_content_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-card .mg-card-btn i.left,
                    {{WRAPPER}} .mg-card .mg-card-btn .left i' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-card .mg-card-btn svg.left,
                    {{WRAPPER}} .mg-card .mg-card-btn .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-card .mg-card-btn i.right,
                     {{WRAPPER}} .mg-card .mg-card-btn .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-card .mg-card-btn svg.right,
                     {{WRAPPER}} .mg-card .mg-card-btn .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-card-text .mg-btn.mg-card-btn i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-card-text .mg-btn.mg-card-btn svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        <div class="mg-card">
            ...
            <div class="mg-card-text">
                ...
                if ($mg_card_title) :
                    printf(
                        '<%1$s %2$s>%3$s</%1$s>',
                        mg_validate_html_tag($mg_card_title_tag),

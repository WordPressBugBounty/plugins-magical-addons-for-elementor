...
?>
        ...
        <?php
        $mgac_rand = wp_rand(253495, 56934658);
        ...
        <div class="accordion mgaccordion mg-<?php echo esc_attr($settings['mgac_style']); ?> <?php echo esc_attr($mgac_excolor); ?>" id="mgAccordion<?php echo esc_attr($mgac_rand); ?>">
                            ...
                            <div class="mgrc-title <?php if ($item['mgac_is_open'] != 'yes') : ?>collapsed<?php endif; ?> <?php if ($settings['mgac_icon_position'] == 'left') : ?>mgrc-left<?php endif; ?>" data-bs-toggle="collapse" data-bs-target="#mgc-item<?php echo esc_attr($index); ?><?php echo esc_attr($mgac_rand); ?>" aria-expanded="<?php echo ($item['mgac_is_open'] == 'yes') ? 'true' : 'false'; ?>" aria-controls="mgc-item<?php echo esc_attr($index); ?><?php echo esc_attr($mgac_rand); ?>">
                                <?php if ($settings['mgac_icon_position'] == 'left' && $settings['mgac_icon_show'] == 'yes') : ?>
                                    <div class="mgc-icons mgc-left-icon">
                                        <div class="mgc-icon">
                                            <span class="mgc-close"><?php \Elementor\Icons_Manager::render_icon($settings['mgac_selected_icon'], ['aria-hidden' => 'true']); ?></span>
                                        </div>
                                        <div class="mgc-icon">
                                            <span class="mgc-open"><?php \Elementor\Icons_Manager::render_icon($settings['mgac_selected_active_icon'], ['aria-hidden' => 'true']); ?></span>
                                        </div>
                                    </div>
                                <?php endif; ?>

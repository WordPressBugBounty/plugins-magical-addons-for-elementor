...
class MgAddon_Banner extends \Elementor\Widget_Base
{
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-flip-btn .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-flip-btn .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-flip-btn .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} a.mg-flip-btn:hover .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} a.mg-flip-btn:hover .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} a.mg-flip-btn:hover .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mgcla-btn2 .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2 .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2 .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}}  a.mgcla-btn2:hover .left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} a.mgcla-btn2:hover .right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} a.mgcla-btn2:hover .right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    public function mgcta_style_base_one($settings)
    {
        ...
        $this->add_inline_editing_attributes('mg_cta_subtitle');

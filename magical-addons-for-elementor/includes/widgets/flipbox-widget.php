    ...
    protected function register_style_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mgf-normal-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgf-normal-icon svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mgf-normal-icon svg' => 'fill: {{VALUE}};',
                ],
                'condition' => [
                    'mgf_icon_type' => 'icon',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-flip-btn i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mg-flip-btn svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-flip-btn i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-flip-btn svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mg-flip-btn:hover i, {{WRAPPER}} .mg-flip-btn:focus i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mg-flip-btn:hover svg, {{WRAPPER}} .mg-flip-btn:focus svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
...
?>
    ...
    public function flip_style_base_two($settings)
    {
        ...
        $this->add_inline_editing_attributes('mg_flip_style_two_normal_title');

	...
	{ // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'             => [
					'{{WRAPPER}} .mg-content-reveal-button-content .mg-button-icon' => 'font-size: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .mg-content-reveal-button-content .mg-button-icon svg' => 'line-height: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}};',
				],
				'conditions'            => [
					'relation' => 'or',
					'terms' => [

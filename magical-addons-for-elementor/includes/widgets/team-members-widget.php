	...
	protected function register_style_controls()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .mg-social ul li a svg' => 'width: {{SIZE}}{{UNIT}};min-width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};min-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .mg-social ul li a svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .mg-social ul li a:hover i, {{WRAPPER}} .mg-btn:focus i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .mg-social ul li a:hover svg, {{WRAPPER}} .mg-btn:focus svg' => 'fill: {{VALUE}};',
				],
			]
		);

...
class MgAddon_Call_To_Action extends \Elementor\Widget_Base
{
    ...
    {
        return 'mgcall_to_action_widget';
    }
    ...
    {
        return __('MG Call to action', 'magical-addons-for-elementor');
    }
    ...
    {
        return ['call to action', 'image', 'action', 'call', 'mg'];
    }
    ...
    function register_content_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'input_type'  => 'text',
                'placeholder' => __('Enter Call To Action Title', 'magical-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __('A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which', 'magical-addons-for-elementor'),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mgcla-btn span.left' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn span.left i' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn span.left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn span.right' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn span.right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn span.right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mgcla-btn:hover span.left' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn:hover span.left i' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn:hover span.left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn:hover span.right' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn:hover span.right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn:hover span.right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}}  .mgcla-btn2 span.left' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}  .mgcla-btn2 span.left i' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}  .mgcla-btn2 span.left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2 span.right' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2 span.right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2 span.right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}  .mgcla-btn2:hover span.left' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}  .mgcla-btn2:hover span.left i' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}  .mgcla-btn2:hover span.left svg' => 'margin-right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2:hover span.right' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2:hover span.right i' => 'margin-left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2:hover span.right svg' => 'margin-left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-cta.mgcta-border-show-left, {{WRAPPER}} .mg-cta.mgcta-border-show-right' => 'border-width: {{SIZE}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mg-cta.mgcta-border-show-left, {{WRAPPER}} .mg-cta.mgcta-border-show-right' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} a.mg-flip-btn.mgcla-btn i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} a.mg-flip-btn.mgcla-btn svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} a.mg-flip-btn.mgcla-btn i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} a.mg-flip-btn.mgcla-btn svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} a.mg-flip-btn.mgcla-btn:hover,
                    {{WRAPPER}} a.mg-flip-btn.mgcla-btn:hover i,
                    {{WRAPPER}} a.mg-flip-btn.mgcla-btn:focus,
                    {{WRAPPER}} a.mg-flip-btn.mgcla-btn:focus i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} a.mg-flip-btn.mgcla-btn:hover svg,
                    {{WRAPPER}} a.mg-flip-btn.mgcla-btn:focus svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mgcla-btn2 i' => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .mgcla-btn2 svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .mgcla-btn2 i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mgcla-btn2 svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mgcla-btn2:hover, 
                    {{WRAPPER}} .mgcla-btn2:hover i,
                    {{WRAPPER}} .mgcla-btn2:focus,
                    {{WRAPPER}} .mgcla-btn2:focus i' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .mgcla-btn2:hover svg,
                    {{WRAPPER}} .mgcla-btn2:focus svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
    ...
    public function mgcta_style_base_one($settings)
    {
        ...
        // Btn item    
        $mgctaborder_show = $settings['mgctaborder_show'];
        $mgcta_border_position = $settings['mgcta_border_position'];
...
?>
        ...
        <div class="mg-cta style-one mg-shadow mgcta-<?php echo esc_attr($mgcta_btn_align); ?> mgcta-border-<?php echo esc_attr($mgctaborder_show); ?>-<?php echo esc_attr($mgcta_border_position); ?>">
    ...
    public function mgf_button($settings, $btn = 1)
    {
        ...
        <?php else : ?>
            <a <?php echo $this->get_render_attribute_string($btn_attr); ?>><?php echo  mg_kses_tags($mg_flip_btn_title); ?></a>
        <?php endif; ?>
<?php
